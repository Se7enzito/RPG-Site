...
class Login:
    ...
    def setar_forca(self, id: int, valor: int):
        self.conectar()
        self.cursor.execute("UPDATE users (forca) WHERE id = ? VALUES (?)", (id, valor))
    ...
    def setar_inteligencia(self, id: int, valor: int):
        self.conectar()
        self.cursor.execute("UPDATE users (inteligencia) WHERE id = ? VALUES (?)", (id, valor))
        self.connection.commit()
        self.desconectar()
    ...
    def setar_cabelo(self, id: int, valor: str):
        self.conectar()
        self.cursor.execute("UPDATE users (cabelo) WHERE id = ? VALUES (?)", (id, valor))
        self.connection.commit()
        self.desconectar()
    ...
    def setar_corpele(self, id: int, valor: str):
        self.conectar()
        self.cursor.execute("UPDATE users (cor_pele) WHERE id = ? VALUES (?)", (id, valor))
        self.connection.commit()
        self.desconectar()
    ...
    def consultar_nickname(self) -> list:
        self.conectar()
        consulta = self.cursor.execute("SELECT nickname FROM users").fetchall()
        self.desconectar()
